...
def plugin_powertable():
    ...
    editablecallback = extra.get('editable',{}).get('editablecallback','../plugin_powertable/editable.load') 
    detailscallback = extra.get('details',{}).get('detailscallback','../plugin_powertable/details')
    ...
    /*click on image to show details*/
                    ...
                    /*click on image to show details*/
                    """ % dict(_class=_class,detailscallback=detailscallback)
